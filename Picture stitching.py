...
# 載入圖片
messagetext_off = Image.open("icon/message-text off.png")
alarmclock_on = Image.open("icon/alarm-clock on.png")
...
# 將第二張圖片貼在右邊
new_image.paste(alarmclock_on, (width1+5, 0))

# 顯示或儲存拼接後的圖片
# new_image.show()
new_image.save("icon/off-on_image.png")
